...
/*
    ...
    El tamaño de la silla se basa en una variable n que indicará el tamaño de la figura
    a imprimir en una matriz de n x n.
...
public class ImprimirSilla {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Introduce en tamaño de matriz: ");
        int n = sc.nextInt();
